    ...
    <Box sx={{ flexGrow: 1 }}>
      <AppBar position="fixed" sx={{ zIndex: (theme) => theme.zIndex.drawer + isLargeScreen, backgroundColor: 'rgb(0, 0, 22)' }}>
        <Toolbar>
          ...
          <Avatar alt="Rishi-dev" src="https://media.istockphoto.com/id/1399472601/vector/registered-trademark-symbol-line-art-style.jpg?s=612x612&w=0&k=20&c=nP_YwjyHOcLNTqXzypK7z6m9lZpCkhziDDDL4wYFWHY=" />
          <Search>
            <SearchIconWrapper>
              <SearchIcon />
            </SearchIconWrapper>
