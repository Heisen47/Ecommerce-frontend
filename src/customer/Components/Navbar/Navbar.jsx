        ...
        <div className="mx-auto px-4">
          <div className="flex justify-between items-center">
            ...
            <Link to="/" className="flex items-center py-6">
              <img
                src="https://media.istockphoto.com/id/1399472601/vector/registered-trademark-symbol-line-art-style.jpg?s=612x612&w=0&k=20&c=nP_YwjyHOcLNTqXzypK7z6m9lZpCkhziDDDL4wYFWHY="
                alt="Rishi-dev"
